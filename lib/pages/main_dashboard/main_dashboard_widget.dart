        ...
        body: Column(
          ...
          children: [
            Container(
              ...
              child: Padding(
                padding: EdgeInsetsDirectional.fromSTEB(24.0, 20.0, 24.0, 12.0),
                child: Container(
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                                          ...
                                          children: [
                                            ...
                                            wrapWithModel(
                                              ...
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: ActionItemWidget(
                                                icon: 'barcode_scanner_rounded',
                                                label: 'Stock',
                                                target: 'ProductInventory',
                                                tone: Color(0xFF673AB7),
                                              ),
                                            ),
                                            wrapWithModel(
                                              model: _model.actionItemModel4,
                                              updateCallback: () =>
                                                  safeSetState(() {}),
                                              child: ActionItemWidget(
